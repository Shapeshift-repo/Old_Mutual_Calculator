        ...
        >
            <div className="w-full h-full relative">
                ...
                <img
                    ...
                    alt="Banner Image"
                    className={`w-full h-full mobile-banner-image object-cover transition-transform duration-300 ease-in-out transform hover:scale-110 hover:rotate-3 block lg:hidden ${mobileImageStyles}`} // Show mobile image only on mobile screens
                />
                <img
