...
export default function ColorCard({
  ...
  return (
    <div
      className={`color-card relative px-[58px] pb-[60px] rounded-[20px] ${className}`}
      style={{
        background: "linear-gradient(90deg, #009677 0%, #50B848 143.37%)",
      }}
    >
      <div className="flex flex-col justify-between items-center gap-[26px]">
        <div className="flex flex-col justify-between items-center gap-[26px]">
          ...
          {content && (
            <div
              className="text-[20px] lg:text-[22px] leading-[25px] text-white font-light color-card-content"
          ...
          {heading && (
            <Heading
              content={heading}
              className="text-[37px] lg:text-[47px] pb-0 leading-[25px] font-semibold text-white"
              tag="h4"
            />
          )}
        ...
        <div className="section-shadow absolute left-0 bottom-[5px] w-full h-[71px] z-[-1]">
          ...
          >
            <g opacity="0.6" filter="url(#filter0_f_1_25916)">
              <path
                d="M673.736 103.611C482.295 83.1805 199.446 95.0984 81.9508 103.611C18.9994 116.23 31.2879 62.8001 45.301 34.5078H709.308C726.914 60.7971 744.449 111.423 673.736 103.611Z"
                fill="url(#paint0_linear_1_25916)"
              />
            </g>
            <defs>
              <filter
                id="filter0_f_1_25916"
                x="0"
                y="0.507812"
                width="759"
                height="139"
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="17"
                  result="effect1_foregroundBlur_1_25916"
                />
              </filter>
              <linearGradient
                id="paint0_linear_1_25916"
                x1="34"
                y1="70.0078"
                x2="725"
                y2="70.0078"
