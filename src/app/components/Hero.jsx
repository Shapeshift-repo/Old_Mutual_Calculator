...
export default function Hero() {
  ...
  const heroContent = {
    ...
    description:
      "Five steps to a secure financial <br>future for you, & your family.",
        ...
        <div className="flex flex-col gap-[40px] lg:gap-[160px] lg:flex-row items-center">
          ...
          <div className="w-full order-1 lg:order-2">
            <div className="relative flex justify-center lg:block w-[222px] lg:max-w-[490px] ml-[38%] lg:ml-0">
              <svg
                className="w-[222px] lg:w-[515px] h-auto"
                width="490"
                height="632"
                viewBox="0 0 515 632"
                fill="none"
              ...
              <div className="shodow-holder absolute bottom-[-65px] lg:bottom-[-115px] left-[-25px]">
                <svg
                  className="w-full lg:w-[430px] h-auto"
                  width="430"
                  height="298"
                  viewBox="0 0 430 298"
                  fill="none"
                ...
                >
                  <g opacity="0.5" filter="url(#filter0_f_1_66381)">
                    <ellipse
                      ...
                      rx="131"
                      ry="65"
                      fill="url(#paint0_linear_1_66381)"
                    />
                  </g>
                  <defs>
                    <filter
                      id="filter0_f_1_66381"
                      x="0"
                      y="0"
                      width="430"
                      height="298"
                    ...
                    >
                      ...
                      <feGaussianBlur
                        stdDeviation="42"
                        result="effect1_foregroundBlur_1_66381"
                      />
                    </filter>
                    <linearGradient
                      id="paint0_linear_1_66381"
                      x1="84"
                      y1="149"
                      x2="346"
                      y2="149"
