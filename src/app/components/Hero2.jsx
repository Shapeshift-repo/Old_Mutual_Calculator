                    ...
                    <div className="relative z-[1] w-full flex flex-col gap-[15px] order-2 lg:order-1">
                        ...
                        <div className="relative">
                            <Heading 
                                ...
                                className="text-[35px] leading-[40px] lg:text-[42px] lg:leading-[44px] font-light text-[#323232] text-center lg:text-left max-w-[483px]" 
                                tag="h2"
                            />
                        </div>
                        ...
                        <div className="flex gap-[8px] justify-center lg:justify-start mt-[20px]">
                            ...
                            <Button onClick={scrollToSection2} label={heroContent.buttonLabel2} Icon={icon} className="down-bounce text-white max-w-[215px]" />
                        </div>
                    </div>
                    <div className="w-full order-1 lg:order-2">
                        <div className="relative flex justify-center lg:block">
                            ...
                            <Image
                                ...
                                width={777.5}
                                height={823}
                                className="w-[332px] lg:w-[750px] lg:max-w-[750px] h-auto opacity-0 animate-zoom-in"
                            />
