...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <span className="toggle-sideform absolute top-[20px] right-[20px] cursor-pointer" onClick={toggleSideForm}>          
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 1L17 17" stroke="#009677" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M1 17L17 1" stroke="#009677" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </span>
        <Heading 
          content="Let's talk"
              ...
              <li className="submenu relative group">
                <Link className={`link ${pathname === '/about' ? 'active' : ''}`} href="#">
                  ...
                  <svg className="submenu-icon" width="11" height="7" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L5.5 5.5L10 1" stroke="#009677" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </Link>
      ...
      <div className={`side-menu fixed z-10 top-0 left-0 w-full max-w-[428px] h-full py-[160px] px-[60px] bg-gradient-to-r from-[#009677] to-[#50B848] transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden`}>
        <span className="toggle-menu absolute top-[20px] right-[20px] cursor-pointer" onClick={toggleMenu}>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 1L17 17" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M1 17L17 1" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </span>
        <nav>
          <ul className="flex flex-col gap-[16px] [&>li]:mb-[16px] [&>li>a]:text-[18px] [&>li>a]:leading-[25px] [&>li>a]:text-white [&>li>a]:font-light">
            ...
            <li className="submenu relative">
              ...
              <ul className={`mt-[10px] [&>li>a]:text-[18px] [&>li>a]:leading-[40px] [&>li>a]:text-white [&>li>a]:font-light ${isDropdownOpen ? 'hidden' : 'block'}`}>
                  ...
                  <li>
                    <Link href="/pay-yourself-first" onClick={toggleMenu}>Pay Yourself First</Link>
                  </li>
              </ul>
            </li>
          </ul>
