...
export default function StepButton({heading = null, content = null, link = null, className = ""}) {
  return (
    <div className="container px-[34px] lg:px-0">
        <Link href={link} 
            className={`link flex w-full items-center step-btn relative px-[28px] lg:px-[58px] py-[18px] min-h-[122px] lg:min-h-[153px] rounded-[20px] ${className}`}
        ...
        >
            <div className="flex justify-between items-center gap-[30px]">
                ...
                {link && (
                <div>
                    <svg className="move-right" width="29" height="16" viewBox="0 0 29 16" fill="none" xmlns="http://www.w3.org/2000/svg">
