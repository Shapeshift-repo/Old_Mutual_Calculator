        ...
        <div className="container">
            <div className="shadow-box-holder bg-white pt-[24px] lg:pt-[52px] pb-0 px-[27px] lg:px-[70px] rounded-[30px] shadow-[0_4px_64px_0_rgba(0,0,0,0.12)] lg:shadow-[0_0_12px_0_rgba(0,0,0,0.12)]">
              <div className="relative overflow-hidden">
                {showLeftArrow && (
                  <button
                    className="absolute block lg:hidden top-[10px] left-0 z-10"
                    onClick={() => scroll('left')}
                  >
                    
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7.17035 15.4638C7.33004 15.3041 7.41976 15.0875 7.41976 14.8617C7.41976 14.6359 7.33004 14.4193 7.17035 14.2596L3.25053 10.3398L17.8609 10.3398C18.0747 10.3232 18.2744 10.2266 18.4201 10.0692C18.5658 9.91182 18.6467 9.70525 18.6467 9.49078C18.6467 9.27631 18.5658 9.06974 18.4201 8.91235C18.2744 8.75495 18.0747 8.65833 17.8609 8.64179L3.27462 8.64179L7.16433 4.75208C7.32402 4.59239 7.41373 4.3758 7.41373 4.14996C7.41373 3.92412 7.32402 3.70753 7.16433 3.54784C7.00463 3.38814 6.78804 3.29843 6.5622 3.29843C6.33636 3.29843 6.11977 3.38815 5.96008 3.54784L0.540986 8.96693C0.397263 9.11066 0.31652 9.30559 0.31652 9.50884C0.31652 9.7121 0.397263 9.90703 0.540986 10.0508L5.96008 15.4698C6.03966 15.5494 6.13422 15.6125 6.23831 15.6553C6.34239 15.6981 6.45393 15.7198 6.56647 15.7193C6.67901 15.7187 6.79033 15.6959 6.89398 15.652C6.99763 15.6082 7.09157 15.5442 7.17035 15.4638Z" fill="#009677"/>
                    </svg>
                ...
                <div className="pt-[35px] px-0 pb-[100px] lg:p-[85px]">
                  ...
                  />
                  <div 
                    className="text-[16px] leading-[24px] lg:text-[20px] lg:leading-[35px] font-light [&>a]:text-primary [&>a]:underline [&>a]:font-medium">
