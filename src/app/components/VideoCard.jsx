          ...
          <div>
              <button className="absolute top-0 left-0 w-full h-full flex justify-center items-center" onClick={() => setOpen(true)}>
                  ...
                  <svg className="absolute" width="148" height="148" viewBox="0 0 148 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M65.9375 89.4019V58.6359C65.9375 57.2836 67.4335 56.4668 68.571 57.1981L92.5002 72.5811C93.5468 73.2539 93.5468 74.7838 92.5002 75.4567L68.571 90.8397C67.4335 91.5709 65.9375 90.7542 65.9375 89.4019ZM69.356 86.2712L88.4151 74.0189L69.356 61.7666V86.2712Z" fill="#009677"/>
                  </svg>
              </button>
          </div>
