...
const RangeSlider = ({
    ...
    const handleNotification = (value, max) => {
        if (
            typeof notificationShown !== "undefined" &&
            !notificationShown &&
            (value / max) * 100 >= 50
        ) {
    ...
    return (
        <div className="w-full group/slider relative">
            {budget === 0 || budget === undefined || budget === "" ? (
                <div className="p-5 bg-[#F7F7F7] left-[50%] z-20 top-[50%] translate-x-[-50%] translate-y-[-50%] rounded-lg shadow-xl absolute w-[250px] hidden group-hover/slider:block">
            ...
            <Slider
                ...
                onChange={(event, value) => {
                    onUpdate(value), handleNotification(value, max);
                }}
                sx={{
