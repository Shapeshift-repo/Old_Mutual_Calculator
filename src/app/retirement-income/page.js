...
export default function RetirementAnnuity() {
  ...
  const handleSlide2Change = (event, newValue) => {
    ...
    monthlyInvest = parseFloat(
      String(monthlyInvest || "").replace(/[^\d]/g, "")
    ...
    if (!isNaN(monthlyInvest)) {
      const result = calculateInvestmentAndTax(
        { ...formData, monthlyInvest },
        newValue
      ); // Pass the updated slider value
      setResult(result);
    }
  };
  ...
  const calculateRoundedValue = (G45, P50, E52) =>
    Math.round((G45 + P50) / E52 / 12);
      ...
      <Page size={{ width: 595.28, height: 920 }} style={styles.page}>
        ...
        <View style={styles.contentTop1}>
          ...
          <Text style={styles.contentAfterHi}>
            ...
            >
              www.oldmutual.co.za/two-pot-retirement-system
            </PDFLink>
            .
          </Text>
        </View>
        ...
        <View style={styles.contentTop2}>
          <Text>
            If you manage to save up a capital amount of{" "}
            ...
            per month at a drawdown rate of{" "}
        ...
        <View style={styles.imageBoxes}>
          <View style={styles.box}>
            <Text style={styles.boxText}>
              You can expect a monthly income of
            </Text>
            <Text style={styles.boxBold}>
              R{result ? formatNumberWithSpaces(result.E52) : 0}
            </Text>
          </View>

          <View style={[styles.box, styles.boxBorder]}>
            <Text style={styles.boxBorderHeading}>Your income will last</Text>
            <Text style={styles.boxBorderLabel}>
              {result ? formatNumberWithSpaces(result.P53) : 0} Years
            </Text>
            ...
            <Text style={[styles.boxBorderLabel, styles.boxBorderLabelGreen]}>
              {result ? formatNumberWithSpaces(result.P54) : 0} Years
            </Text>
        ...
        <View style={styles.smallTextWrapper}>
          <Text style={styles.smallText}>
            The income illustration above is for a living annuity.
          </Text>
        </View>

        <View style={styles.contentBottom}>
          <Text style={styles.bottomHeading1}>
          ...
          <Text>
            ...
            You can adjust your income every year, but if your investment
            underperforms or you withdraw too much, you could run out of
            retirement savings.
          </Text>
          ...
          <Text>
            A guaranteed annuity ensures that you receive a regular income for
            as long as you live. You can choose an escalation option that
            determines how the purchasing power of your income will increase or
            decrease over time.
          </Text>
          <Text style={styles.bottomHeading2}>
          ...
          <Text>
            By combining the features of a living annuity and a guaranteed
            annuity, a composite annuity ensures that you receive an income for
            life and allows you to keep a portion of your capital invested in
            the markets.
          </Text>
          ...
          <Text>
            It really is smart to contribute to a retirement annuity and have
    ...
    <section className="tax-back-section pt-0 lg:pt-[118px] pb-[100px]">
      <div className="container px-0 lg:px-[15px]">
        <div className="flex flex-col lg:flex-row gap-0 lg:gap-[150px] items-start">
          ...
          <div className="w-full relative min-h-[400px] 2xl:min-h-[900px]">
            ...
            <div id="form-output" className="form-output hidden relative">
              <div
                id="anchor-point"
                className="pt-[110px] mt-[59px] lg:mt-[99px]"
              ></div>
              <div className="output-holder relative z-10">
                <div className="estimate-box">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(98.34deg, #009677 4.08%, #50B848 100%)",
                    }}
                  >
                    <p className="text-[22px] leading-[19px] font-light text-white text-center w-full">
                      Estimated monthly income
                    </p>
                    <Heading
                      content={`R${
                        result ? formatNumberWithSpaces(result.E52) : ""
                      }`}
                ...
                <div className="container px-[34px] lg:px-0">
                  <ColorCard
                    ...
                    content={`
                                            ...
                                            <p><strong>Living annuity</strong><br>A living annuity is a flexible plan where you decide how your savings are invested and you choose an income level that suits your needs.</p>
                                            <p><strong>Guaranteed (or life) annuity</strong><br>A guaranteed annuity ensures that you receive a regular income for as long as you live.</p>
                                            <p><strong>Composite (or compound) annuity</strong><br>By combining the features of a living annuity and a guaranteed annuity, a composite annuity ensures that you receive an income for life and allows you to keep a portion of your capital invested in the markets.</p>
                                        `}
